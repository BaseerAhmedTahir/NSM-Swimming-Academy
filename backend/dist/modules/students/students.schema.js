...
exports.updateStudentSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        age: zod_1.z.coerce.number().int().min(1).max(100).optional(),
        ...
        paymentStatus: zod_1.z.enum(['PAID', 'PENDING', 'PARTIAL']).optional(),
        paidAmount: zod_1.z.coerce.number().min(0).optional(),
        vatAmount: zod_1.z.coerce.number().min(0).optional(),
...
exports.createStudentSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        branchId: zod_1.z.string().optional(),
        discount: zod_1.z.coerce.number().min(0).optional().default(0),
        paymentMode: zod_1.z.enum(['CASH', 'CARD', 'ONLINE']),
        paymentStatus: zod_1.z.enum(['PAID', 'PENDING', 'PARTIAL']).default('PAID'),
        paidAmount: zod_1.z.coerce.number().min(0).optional(),
        vatAmount: zod_1.z.coerce.number().min(0).optional(),
        isInstallment: zod_1.z.boolean().optional().default(false),
        trn: zod_1.z.string().optional(),
    })
});
